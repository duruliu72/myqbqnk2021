            ...
            <nav className="navbar navbar-default">
                <div className="container-fluid">
                    ...
                    <ul className="nav navbar-right float-right list-inline">
                        ...
                        {props.user && <li className="dropdown open">
                            <a href="#" className="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img
                                src="assets/images/users/avatar-1.jpg" alt="user-img" className="rounded-circle" /> </a>
                            <ul className="dropdown-menu">
                                ...
                                <li><Link to="/x" href="javascript:void(0)" className="dropdown-item"><i className="md md-lock mr-2"></i>
                                            Lock screen</Link></li>
                                <li><Link to="/logout" href="javascript:void(0)" className="dropdown-item"><i
